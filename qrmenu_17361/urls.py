"""qrmenu_17361 URL Configuration
...
admin.site.site_header = "QrMenu"
admin.site.site_title = "QrMenu Admin Portal"
admin.site.index_title = "QrMenu Admin"
...
schema_view = get_schema_view(
    openapi.Info(
        title="QrMenu API",
        default_version="v1",
        description="API documentation for QrMenu App",
    ),
    public=True,
